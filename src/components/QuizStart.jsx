  ...
  return (
    <div className='max-w-4xl mx-auto'>
      <div className='bg-white rounded-2xl shadow-xl p-8 text-center'>
            ...
            <div className='text-left bg-gray-50 p-6 rounded-xl max-w-2xl mx-auto'>
                ...
                >
                    <li className='flex items-start'>
                        <span className='flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center
                        font-semibold mr-3 mt-0.5 justify-center text-sm'>
                            1
                        </span>
                    ...
                    <li className='flex items-start'>
                        ...
                        <span>Once you select an answer, you'll see the explanation</span>
                    </li>
                    <li className='flex items-start'>
                        <span className='flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center
                        font-semibold mr-3 mt-0.5 justify-center text-sm'>
        ...
        {/*  */}
        <button 
        className='inline-flex items-center space-x-3 py-4 px-8 bg-gradient-to-r from-blue-500 to-purple-600
